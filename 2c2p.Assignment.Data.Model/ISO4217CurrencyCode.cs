...
namespace _2c2p.Assignment.Data.Model
{
    public class ISO4217CurrencyCode
    {
        ...
        public enum Values
        {
            ...
            MGA,    //969	2[c] Malagasy ariary  Madagascar
            ...
            MRU,    //[11] 929	2[c] Mauritanian ouguiya  Mauritania
            ...
            STN,//[13] 930	2	São Tomé and Príncipe dobra São Tomé and Príncipe
        ...
        public static EnumToStringConverter<Values> FluentInitAndSeed(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ISO4217CurrencyCode>(entity => {
            ...
            foreach (var v in values)
            {
                modelBuilder.Entity<ISO4217CurrencyCode>(entity =>
                {
                    entity.HasData(new ISO4217CurrencyCode() { V = v });
                });
            }
